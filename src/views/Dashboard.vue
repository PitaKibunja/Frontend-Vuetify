    ...
    <v-container class="my-5">
      ...
      <v-tooltip top>
        <template v-slot:activator="{ on, attrs }">
            ...
            <v-btn v-bind="attrs"  v-on="on" small flat color="grey" @click="sortBy('title')" slot="activator">
      ...
      <v-card flat dark class="pa-3" color="grey" v-for="project in projects" :key="project.person" >
